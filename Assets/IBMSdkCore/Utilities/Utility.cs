...
{
    /// <summary>
    /// UtilityWatson functions.
    /// </summary>
    static public class UtilityWatson
    {
        ...
        public static DateTime GetLocalDateTimeFromEpoch(double epochTime)
        {
            ...
            {
                Log.Debug("UtilityWatson.GetLocalDateTimeFromEpoch()", "Time conversion assuming time is in Milliseconds: {0}, {1}", epochTime, ex.Message);
        ...
        public static T DeserializeResponse<T>(string json, object obj = null) where T : class, new()
        {
            ...
            {
                Log.Error("UtilityWatson.DeserializeResponse()", "Exception: {0}", e.ToString());
            }
    ...
    public class SimpleGet : IDisposable
    {
        ...
        private IEnumerator GetRequest()
        {
            ...
            using (UnityWebRequest unityWebRequest = UnityWebRequest.Get(_url))
            {
                ...
                {
                    authorization = UtilityWatson.CreateAuthorization(_username, _password);
                }
